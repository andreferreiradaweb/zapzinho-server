...
const envSchema = z.object({
  ...
  WAPI_DELAY_MIN_MS: z.coerce.number().default(60000),
  WAPI_DELAY_MAX_MS: z.coerce.number().default(180000),
  WAPI_WEBHOOK_SECRET: z.string().default(''),
  GEMINI_API_KEY: z.string().default(''),
  FRONTEND_URL: z.string().default('https://zapzinho.vercel.app'),
  WEBHOOK_CALLERS: z.string().default(''),
  RESEND_API_KEY: z.string().default(''),
  RESEND_FROM_EMAIL: z.string().default('noreply@zapzinho.com.br'),
  RESEND_FROM_NAME: z.string().default('Zapzinho'),
